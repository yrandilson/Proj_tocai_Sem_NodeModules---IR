import { IsString, IsEmail, MinLength, IsOptional, IsEnum, MaxLength, IsNumber, Min, Max, IsNotEmpty, IsBoolean } from 'class-validator';
...
export class CreateReportDTO {
  ...
  @IsNotEmpty({ message: 'ID do usuário denunciado é obrigatório.' })
